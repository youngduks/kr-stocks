    ...
    <header className="sticky top-0 z-30 backdrop-blur-md bg-bg/80 border-b border-line">
      <div className="max-w-6xl mx-auto px-5 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-2.5 h-2.5 rounded-full bg-accent-green animate-pulse-soft shadow-[0_0_12px_#1FAE6F]" />
          <div>
            <div className="text-base font-bold text-text tracking-tight">KR Stocks</div>
            <div className="text-[11px] text-text-dim font-medium">24h Global Markets</div>
          </div>
        </div>
