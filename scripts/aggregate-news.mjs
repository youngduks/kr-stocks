...
const FILTERS = {
  ...
  hyundai: [
    ...
    "현대모비스","모비스",
    // 차종 (현대·기아·제네시스)
    "그랜저","팰리세이드","쏘나타","아반떼","캐스퍼","코나","투싼","제네시스","스타리아","싼타페",
    "EV6","EV9","니로","K5","K8",
    // 한국 자동차 산업 macro
    "K배터리","K-배터리","K-자동차","K-EV",
    "자동차 수출","자동차 판매","신차 출시","완성차",
    // 경쟁사 (글로벌 EV/완성차)
    "테슬라","Tesla","BYD","비야디","폭스바겐","Volkswagen","도요타","Toyota","리비안","Rivian",
    // 자율주행 / 모빌리티
    "자율주행","로보택시",
    // 로봇 신사업 (현대차그룹 보스턴다이나믹스 + 한국 휴머노이드 산업 macro)
    "보스턴다이나믹스","Boston Dynamics",
    "휴머노이드","humanoid","Humanoid",
    "로보틱스","Robotics",
    "로봇개","사족보행 로봇","피지컬 AI",
    "두산로보틱스","레인보우로보틱스","뉴로메카",
    "Figure AI","Optimus","옵티머스",
  ],
};
